 ...
 * @param useLevelDef
 */
class ConsoleFormatter(dateFmtDef: String,
    threadLenDef: Int = -1,
    ...
    useLevelDef: Boolean = true) extends MyFormatter(dateFmtDef, threadLenDef, loggerNameLenDef, useFakeDateDef, useResourceDef, useMethodNameDef, addHeaderDef,useLevelDef)
{
